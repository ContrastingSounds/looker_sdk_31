...
api_instance = looker_client_31.AuthApi()
body = looker_client_31.OIDCConfig() # OIDCConfig | OIDC test config
...
# create an instance of the API class
api_instance = looker_client_31.AuthApi()
body = looker_client_31.SamlConfig() # SamlConfig | SAML test config
...
# create an instance of the API class
api_instance = looker_client_31.AuthApi()
body = looker_client_31.LDAPConfig() # LDAPConfig | LDAP Config
...
# create an instance of the API class
api_instance = looker_client_31.AuthApi()
body = looker_client_31.OIDCConfig() # OIDCConfig | OIDC Config
...
# create an instance of the API class
api_instance = looker_client_31.AuthApi()
body = looker_client_31.SamlConfig() # SamlConfig | SAML Config
