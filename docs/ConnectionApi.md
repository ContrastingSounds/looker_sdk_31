# looker_client_31.ConnectionApi
...
api_instance = looker_client_31.ConnectionApi()
...
# create an instance of the API class
api_instance = looker_client_31.ConnectionApi()
body = looker_client_31.DBConnection() # DBConnection | Connection (optional)
...
api_instance = looker_client_31.ConnectionApi()
connection_name = 'connection_name_example' # str | Name of connection
body = looker_client_31.DBConnection() # DBConnection | Connection
