...
api_instance = looker_client_31.GroupApi()
group_id = 789 # int | Id of group
body = looker_client_31.GroupIdForGroupInclusion() # GroupIdForGroupInclusion | Group id to add (optional)
...
api_instance = looker_client_31.GroupApi()
group_id = 789 # int | Id of group
body = looker_client_31.GroupIdForGroupUserInclusion() # GroupIdForGroupUserInclusion | User id to add (optional)
...
# create an instance of the API class
api_instance = looker_client_31.GroupApi()
body = looker_client_31.Group() # Group | Group (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.GroupApi()
group_id = 789 # int | Id of group
body = looker_client_31.Group() # Group | Group
fields = 'fields_example' # str | Requested fields. (optional)
...
group_id = 789 # int | Id of group
user_attribute_id = 789 # int | Id of user attribute
body = looker_client_31.UserAttributeGroupValue() # UserAttributeGroupValue | New value for group.
