...
api_instance = looker_client_31.LookApi()
...
# create an instance of the API class
api_instance = looker_client_31.LookApi()
body = looker_client_31.LookWithQuery() # LookWithQuery | Look (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.LookApi()
look_id = 789 # int | Id of look
body = looker_client_31.LookWithQuery() # LookWithQuery | Look
fields = 'fields_example' # str | Requested fields. (optional)
