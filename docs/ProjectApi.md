...
api_instance = looker_client_31.ProjectApi()
...
# create an instance of the API class
api_instance = looker_client_31.ProjectApi()
body = looker_client_31.Project() # Project | Project (optional)
...
api_instance = looker_client_31.ProjectApi()
project_id = 'project_id_example' # str | Project Id
body = looker_client_31.Project() # Project | Project
fields = 'fields_example' # str | Requested fields (optional)
