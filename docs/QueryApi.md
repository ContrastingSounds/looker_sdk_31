...
# **create_merge_query**
> MergeQuery create_merge_query(body=body, fields=fields)
...
api_instance = looker_client_31.QueryApi()
body = looker_client_31.MergeQuery() # MergeQuery | Merge Query (optional)
fields = 'fields_example' # str | Requested fields (optional)

try:
    # Create Merge Query
    api_response = api_instance.create_merge_query(body=body, fields=fields)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling QueryApi->create_merge_query: %s\n" % e)
```
...
# create an instance of the API class
api_instance = looker_client_31.QueryApi()
body = looker_client_31.Query() # Query | Query (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
# create an instance of the API class
api_instance = looker_client_31.QueryApi()
body = looker_client_31.CreateQueryTask() # CreateQueryTask | Query parameters
...
# **merge_query**
> MergeQuery merge_query(merge_query_id, fields=fields)
...
# create an instance of the API class
api_instance = looker_client_31.QueryApi()
merge_query_id = 'merge_query_id_example' # str | Merge Query Id
fields = 'fields_example' # str | Requested fields (optional)

try:
    # Get Merge Query
    api_response = api_instance.merge_query(merge_query_id, fields=fields)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling QueryApi->merge_query: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **merge_query_id** | **str**| Merge Query Id | 
 **fields** | **str**| Requested fields | [optional] 
...
body = looker_client_31.Query() # Query | inline query
limit = 789 # int | Row limit (may override the limit in the saved query). (optional)
apply_formatting = true # bool | Apply model-specified formatting to each result. (optional)
apply_vis = true # bool | Apply visualization options to results. (optional)
cache = true # bool | Get results from cache if available. (optional)
