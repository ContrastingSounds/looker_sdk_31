# looker_client_31.RenderTaskApi
...
api_instance = looker_client_31.RenderTaskApi()
dashboard_id = 789 # int | Id of dashboard to render
result_format = 'result_format_example' # str | Output type: pdf, png, or jpg
body = looker_client_31.CreateDashboardRenderTask() # CreateDashboardRenderTask | Dashboard render task parameters
