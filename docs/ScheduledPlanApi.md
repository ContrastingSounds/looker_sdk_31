# looker_client_31.ScheduledPlanApi
...
api_instance = looker_client_31.ScheduledPlanApi()
...
# create an instance of the API class
api_instance = looker_client_31.ScheduledPlanApi()
body = looker_client_31.ScheduledPlan() # ScheduledPlan | Scheduled Plan (optional)
...
api_instance = looker_client_31.ScheduledPlanApi()
scheduled_plan_id = 789 # int | Scheduled Plan Id
body = looker_client_31.ScheduledPlan() # ScheduledPlan | Scheduled Plan
