...
api_instance = looker_client_31.SpaceApi()
...
# create an instance of the API class
api_instance = looker_client_31.SpaceApi()
body = looker_client_31.Space() # Space | Space (optional)
...
api_instance = looker_client_31.SpaceApi()
space_id = 'space_id_example' # str | Id of space
body = looker_client_31.Space() # Space | Space
