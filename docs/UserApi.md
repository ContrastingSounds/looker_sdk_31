...
api_instance = looker_client_31.UserApi()
...
# create an instance of the API class
api_instance = looker_client_31.UserApi()
body = looker_client_31.User() # User | User (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | id of user
body = looker_client_31.AccessFilter() # AccessFilter | Access Filter (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | Id of user
body = looker_client_31.CredentialsApi() # CredentialsApi | API Credential (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | id of user
body = looker_client_31.CredentialsApi3() # CredentialsApi3 | API 3 Credential (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | id of user
body = looker_client_31.CredentialsEmail() # CredentialsEmail | Email/Password Credential (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | id of user
body = looker_client_31.CredentialsTotp() # CredentialsTotp | Two-Factor Credential (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
user_id = 789 # int | Id of user
user_attribute_id = 789 # int | Id of user attribute
body = looker_client_31.UserAttributeWithValue() # UserAttributeWithValue | New attribute value for user.
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | id of user
body = [looker_client_31.list[int]()] # list[int] | array of roles ids for user
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | Id of user
body = looker_client_31.User() # User | User
fields = 'fields_example' # str | Requested fields. (optional)
...
user_id = 789 # int | id of user
access_filter_id = 789 # int | id of Access Filter
body = looker_client_31.AccessFilter() # AccessFilter | Access Filter
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserApi()
user_id = 789 # int | id of user
body = looker_client_31.CredentialsEmail() # CredentialsEmail | Email/Password Credential
fields = 'fields_example' # str | Requested fields. (optional)
