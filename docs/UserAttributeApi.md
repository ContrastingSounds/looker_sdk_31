# looker_client_31.UserAttributeApi
...
api_instance = looker_client_31.UserAttributeApi()
...
# create an instance of the API class
api_instance = looker_client_31.UserAttributeApi()
body = looker_client_31.UserAttribute() # UserAttribute | User Attribute (optional)
fields = 'fields_example' # str | Requested fields. (optional)
...
api_instance = looker_client_31.UserAttributeApi()
user_attribute_id = 789 # int | Id of user attribute
body = [looker_client_31.UserAttributeGroupValue()] # list[UserAttributeGroupValue] | Array of group values.
...
api_instance = looker_client_31.UserAttributeApi()
user_attribute_id = 789 # int | Id of user attribute
body = looker_client_31.UserAttribute() # UserAttribute | User Attribute
fields = 'fields_example' # str | Requested fields. (optional)
