...
class ContentApi(object):
    ...
    def all_content_metadata_accesses(self, content_metadata_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.all_content_metadata_accesses(content_metadata_id, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.all_content_metadata_accesses_with_http_info(content_metadata_id, **kwargs)  # noqa: E501
        else:
            (data) = self.all_content_metadata_accesses_with_http_info(content_metadata_id, **kwargs)  # noqa: E501
            return data

    def all_content_metadata_accesses_with_http_info(self, content_metadata_id, **kwargs):  # noqa: E501
        """Get All Content Metadata Accesses  # noqa: E501

        ### All content metadata access records for a content metadata item.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.all_content_metadata_accesses_with_http_info(content_metadata_id, async=True)
        >>> result = thread.get()
        ...
        if ('content_metadata_id' not in params or
            ...
            raise ValueError("Missing the required parameter `content_metadata_id` when calling `all_content_metadata_accesses`")  # noqa: E501
