...
class QueryApi(object):
    ...
    def create_merge_query(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async'):
            return self.create_merge_query_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_merge_query_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_merge_query_with_http_info(self, **kwargs):  # noqa: E501
        """Create Merge Query  # noqa: E501

        ### Create Merge Query  Creates a new merge query object.  A merge query takes the results of one or more queries and combines (merges) the results according to field mapping definitions. The result is similar to a SQL left outer join.  A merge query can merge results of queries from different SQL databases.  The order that queries are defined in the source_queries array property is significant. The first query in the array defines the primary key into which the results of subsequent queries will be merged.  Like model/view query objects, merge queries are immutable and have structural identity - if you make a request to create a new merge query that is identical to an existing merge query, the existing merge query will be returned instead of creating a duplicate. Conversely, any change to the contents of a merge query will produce a new object with a new id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_merge_query_with_http_info(async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='MergeQuery',  # noqa: E501
    ...
    def merge_query(self, merge_query_id, **kwargs):  # noqa: E501
        """Get Merge Query  # noqa: E501

        ### Get Merge Query  Returns a merge query object given its id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.merge_query(merge_query_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.merge_query_with_http_info(merge_query_id, **kwargs)  # noqa: E501
        else:
            (data) = self.merge_query_with_http_info(merge_query_id, **kwargs)  # noqa: E501
            return data

    def merge_query_with_http_info(self, merge_query_id, **kwargs):  # noqa: E501
        """Get Merge Query  # noqa: E501

        ### Get Merge Query  Returns a merge query object given its id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.merge_query_with_http_info(merge_query_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['merge_query_id', 'fields']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('merge_query_id' not in params or
                params['merge_query_id'] is None):
            raise ValueError("Missing the required parameter `merge_query_id` when calling `merge_query`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'merge_query_id' in params:
            path_params['merge_query_id'] = params['merge_query_id']  # noqa: E501
